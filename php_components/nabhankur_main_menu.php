<header>
    <nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark py-3">
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
            <a class="nav-link px-3" href="<?php echo $root_url; ?>/nabhankur/about-navakur-kala-bhawan.php"
                >About us</a
            >
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
            <a class="nav-link px-3" href="<?php echo $root_url; ?>/color_wings">Color Wings</a>
            </li>
