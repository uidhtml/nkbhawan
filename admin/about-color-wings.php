<?php
  ...
  if($_POST){
    ...
    if(isset($title) && isset($body)){
      $query = 'UPDATE about_color_wings SET title=?, body=?';
  ...
  <body class="admin-body-bg">
    <div class="container-fluid p-0">
      <div class="row m-0 p-0">
        <div class="col col-2 p-0 vh-100 position-relative custom-box-shadow sidebar">
        ...
        <div class="col p-0">
          ...
          <div class="page-title text-secondary mb-4 d-flex justify-content-between align-items-center">
            <h1 class="m-0 font-weight-bold text-uppercase">About color wings</h1>
            ...
            <form id="form" action="<?php echo $root_url; ?>/admin/about-color-wings.php" method="post">
